  ...
  export default {
    ...
    methods: {
      ...
      setRights() {
        ...
        this.$http.get(`${this.serverAddress}/Operation/GetToolbar/${this.$route.query.id || "59A2CB76-B6C8-4EDB-9447-E94FF6AC5942"}/${this.$bus.states.userInfo.RoleIdList[0]._id || 'null'}`).then((response) => {
          if (response.data.Code === 1000) {
