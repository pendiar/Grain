<template>
<div class="grain-list row">
  <div class="grain-stats col-100 table-25" v-for="grain in list">
    ...
    <div class="grain-content">
      <div class="grain-floor" v-for="floor in grain.Floors" :style="{height:100/grain.Floors.length+'%'}">
        <div class="grain-granary" v-for="granary in floor.GranaryList">{{granary.Number}}</div>
      </div>
    </div>
  </div>
</div>
...
.grain-top .top-icon.top-icon-ping{
  width: 0;
  height: 0;
  border-style: solid;
...
.grain-top .top-icon.top-icon-ping:after{
  content: "";
  width: 0;
  height: 0;
  border-style: solid;
...
.grain-top .top-icon.top-icon-yuan{
  width: 180px;
  height: 55px;
  border: 1px solid #000;
  border-radius: 50% / 35px 35px 20px 20px;
